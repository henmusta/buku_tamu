...
class UserController extends Controller
{
  ...
  {
    $this->middleware('can:erp-users-list', ['only' => ['index', 'show']]);
    $this->middleware('can:erp-users-create', ['only' => ['create', 'store']]);
    $this->middleware('can:erp-users-edit', ['only' => ['edit', 'update']]);
    $this->middleware('can:erp-users-delete', ['only' => ['destroy']]);
  }
  ...
  public function index(Request $request)
  {
    ...
    return view('erp.users.index', compact('config', 'page_breadcrumbs'));
  }
  ...
  public function create()
  {
    ...
    return view('erp.users.create', compact('page_breadcrumbs', 'config'));
  }
  ...
  public function edit($id)
  {
    ...
    return view('erp.users.edit', compact('page_breadcrumbs', 'config', 'data'));
  }
