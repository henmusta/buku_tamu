...
let app_pages_assets = {
  js: [
    ...
    folder.src + "js/components/left-menu1.js",
    folder.src + "js/components/perfect-scrollbar.min.js",
    folder.src + "js/components/perfect-scrollbar.min-rtl.js",
    folder.src + "js/components/sidebar.js",
    folder.src + "js/components/sidebar-rtl.js",
    folder.src + "js/components/sidemenu.js",
    folder.src + "js/components/sticky.js",
    folder.src + "js/components/toggle-sidemenu.js",
    folder.src + "js/components/switcher.js",
    folder.src + "js/components/switcher.js",
    folder.src + "js/components/switcher.js",
  ]
};
...
let cssStyles = {
  css: [
    ...
    folder.src + "scss/styles/colors/color1.scss",
    ...
    folder.src + "scss/styles/skins.scss",
  ]
};
...
// copy all fonts
mix.copyDirectory(folder.src + "css/web-fonts", folder.dist_assets + "web-fonts");
